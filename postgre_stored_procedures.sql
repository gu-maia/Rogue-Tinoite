CREATE OR REPLACE FUNCTION public.getmatchesof(p_user_id integer)
 RETURNS TABLE(matcher_name character varying, gender character varying, register_date timestamp without time zone, email character varying, liketype text)
 LANGUAGE plpgsql
AS $function$
BEGIN
